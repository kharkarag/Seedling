...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page-wrapper">
                ...
                <div>
                    <section id="banner">
								<header>
									<h2>Hi! Welcome to Seedling.</h2>
									<p>A dynamic team-building app.</p>
								</header>
							</section>
    ...
    {"appName":"Chrome","requestId":"ddd22bfbb4014cebb17ad5999938c7ae"}
    </script>
    <script type="text/javascript" src="http://localhost:8972/689aba8400984cb2a41ce1f0909ccce9/browserLink" async="async"></script>
    <!-- End Browser Link -->
